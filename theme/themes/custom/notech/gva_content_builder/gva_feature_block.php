      ...
      <div class="el-feature-block <?php echo implode(' ', $classes) ?>"> 
               ...
               <div class="feature-one__content">
                  <div class="feature-one__content-inner">
                     <?php 
                        ...
                        if($link){ 
                           print '<div class="feature-one__content-action"><a class="btn-inline" href="' . $link . '"><span>' . t('Read more') . '</span></a></div>';
                        } 
                     ?>
                  </div>
               </div>
         ...
         <?php if($style == 'style-3'){ ?>
            <div class="feature-three__single">
               <?php 
                  if($image){ 
                     echo '<div class="feature-three__image"><img src="' . $base_url . $image . '" alt="' . $title . '"/></div>';
                     if($link){ 
               ...
               <div class="feature-three__content">
                  <div class="feature-three__content-inner">
                     <?php 
                        ...
                        if($link){ 
                           print '<div class="feature-three__content-action"><a class="btn-inline" href="' . $link . '"><span>' . t('Read more') . '</span></a></div>';
                        } 
                     ?>
                  </div>
               </div>
            ...
            <div class="feature-four__single">
               ...
               <div class="feature-four__content">
                  <div class="feature-four__content-inner">
                     <?php 
                        if($icon){
                           print '<span class="feature-four__content-icon"><i class="' . $icon . '"></i></span>';
                        }
                        if($title){
                           print '<h3 class="feature-four__content-title">' .  $title . '</h3>';
                        } 
                        if($content){ 
                           print '<div class="feature-four__content-desc">' . $content . '</div>'; 
                        } 
                        if($link){ 
                           print '<div class="feature-four__content-action"><a class="btn-inline" href="' . $link . '"><span>' . t('Read more') . '</span></a></div>';
                        } 
                     ?>
                  </div>
               </div>
            ...
            <div class="feature-five__single">
               ...
               <div class="feature-five__content">
                  <div class="feature-five__content-inner">
                     <?php 
                        if($icon){
                           print '<span class="feature-five__content-icon"><i class="' . $icon . '"></i></span>';
                        }
                        if($title){
                           print '<h3 class="feature-five__content-title">' .  $title . '</h3>';
                        } 
                        if($content){ 
                           print '<div class="feature-five__content-desc">' . $content . '</div>'; 
                        } 
                        if($link){ 
                           print '<div class="feature-five__content-action"><a class="btn-inline" href="' . $link . '"><span>' . t('Read more') . '</span></a></div>';
                        } 
                     ?>
                  </div>
               </div>
