   ...
   class element_gva_counter{
      ...
      ?>
         ...
         <?php if($style == 'style-1'){ ?>
            <div class="widget milestone-one__single <?php if(count($class) > 0){ print implode(' ', $class); } ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <?php if($icon){ ?>
               ...
               <div class="milestone-one__content">
                  <div class="milestone-one__number-inner">
                     <span class="milestone-one__number"><?php print $number; ?></span>
                     <?php if($symbol){ ?>
         ...
         <?php if($style == 'style-2'){ ?>
            <div class="widget milestone-two__single <?php if(count($class) > 0){ print implode(' ', $class); } ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <?php if($icon){ ?>
               ...
               <div class="milestone-two__content">
                  <div class="milestone-two__number-inner">
                     <span class="milestone-two__number"><?php print $number; ?></span>
                     <?php if($symbol){ ?>
         ...
         <?php if($style == 'style-3'){ ?>
            <div class="widget milestone-three__single <?php if(count($class) > 0){ print implode(' ', $class); } ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               <div class="milestone-three__wrap">
                  ...
                  <div class="milestone-three__content">
                     <div class="milestone-three__number-inner">
                        <span class="milestone-three__number"><?php print $number; ?></span>
                        <?php if($symbol){ ?>
