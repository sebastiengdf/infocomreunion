...
function notech_render_option_font(){
    $fonts = notech_fonts();
    $output = '';
...
function notech_typography_font_styles($option, $selectors) {
    $output = $selectors . ' {';
...
function notech_links_typography_font($json){
    ...
    if(isset($customize['font_family_primary']) && $customize['font_family_primary']){
        $links_fonts .= notech_typography_enqueue_google_font($customize['font_family_primary']);
    }
    if(isset($customize['font_family_second']) && $customize['font_family_second']){
        $links_fonts .= notech_typography_enqueue_google_font($customize['font_family_second']);
    }
    return $links_fonts;
}
