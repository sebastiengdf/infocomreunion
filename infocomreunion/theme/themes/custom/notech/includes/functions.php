<?php
function notech_render_block($key) {
...
function notech_makeid($length = 5){
...
function notech_preprocess_node(&$variables) {
  global $gva_node_index;
...
function _notech_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function notech_preprocess_node__event(&$variables){
  $node = $variables['node'];
  $event_date = array();
...
function notech_preprocess_breadcrumb(&$variables){
...
function notech_print_icon($file, $alt){
