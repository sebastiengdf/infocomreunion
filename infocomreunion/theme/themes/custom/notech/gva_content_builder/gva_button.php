...
if(!class_exists('element_gva_button')):
   class element_gva_button{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <a href="<?php print $link ?>" <?php print $target ?> class="gsc-button <?php print implode('', $classes) ?>" id="<?php print $_id; ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
            <?php print $title ?>
         </a> 
