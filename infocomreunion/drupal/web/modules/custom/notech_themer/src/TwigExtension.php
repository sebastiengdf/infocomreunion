...
class TwigExtension extends AbstractExtension {
  ...
  public function getFunctions() {
    return [
      new TwigFunction('gva_drupal_view', 'views_embed_view'),
      new TwigFunction('gva_drupal_block', [$this, 'drupalBlock']),
      new TwigFunction('gva_drupal_token', [$this, 'drupalToken']),
      new TwigFunction('gva_drupal_entity', [$this, 'drupalEntity']),
      new TwigFunction('gva_drupal_field', [$this, 'drupalField']),
      new TwigFunction('gva_drupal_menu', [$this, 'drupalMenu']),
      new TwigFunction('gva_drupal_config', [$this, 'drupalConfig']),
      new TwigFunction('gva_theme_setting', [$this, 'themeSetting']),
    ];
  }
